...
export const DesktopAuthLayout: React.FC<DesktopAuthLayoutProps> = ({ children }) => {
  ...
  const highlights = [
    {
      icon: <Zap className="h-4 w-4 text-[#7FE87F]" />,
    ...
    {
      icon: <Wifi className="h-4 w-4 text-[#7FE87F]" />,
    ...
    {
      icon: <QrCode className="h-4 w-4 text-[#7FE87F]" />,
      titleEn: 'E-Invoicing',
  ...
  return (
    ...
    >
      ...
      <div className="lg:w-[45%] lg:h-screen flex flex-col justify-between p-8 lg:p-14 bg-[#121212] border-b lg:border-b-0 lg:border-r border-[#2C2C44] bg-[radial-gradient(ellipse_at_20%_20%,rgba(127, 232, 127, 0.14)_0%,transparent_70%)] flex-shrink-0 lg:overflow-hidden">
        <div>
          {/* Brand Logo with exact SVG and Merchant Tag */}
          <div className="flex items-center gap-3">
            <Logo height={38} textColor="#FFFFFF" accentColor="#7FE87F" />
            <Badge variant="outline" className="text-[10px] font-bold text-[#7FE87F] border-[#7FE87F]/40 bg-[#7FE87F]/10">
              MERCHANT
            </Badge>
          </div>
          ...
          <div className="mt-12 lg:mt-16 max-w-md space-y-3">
            ...
            <p className="text-xs lg:text-sm text-[#A2A2BA] leading-relaxed">
              {isAr
          ...
          <div className="flex flex-col gap-3 mt-8 max-w-md">
            {highlights.map((item, i) => (
              <div
                key={i}
                className="flex items-start gap-3.5 p-3.5 rounded-2xl bg-[#111726] border border-[#2C2C44] text-neutral-200 shadow-lg shadow-black/40 hover:border-[#7FE87F]/40 transition-colors"
              >
                <div className="w-8 h-8 rounded-full bg-[#7FE87F]/10 border border-[#7FE87F]/20 flex items-center justify-center text-[#7FE87F] flex-shrink-0 mt-0.5">
                  {item.icon}
                </div>
                <div className="flex-1 min-w-0">
                  ...
                  <div className="text-[11px] text-[#A2A2BA] mt-1 leading-relaxed">
        ...
        <div className="mt-8 pt-6 border-t border-[#2C2C44] flex items-center justify-between text-xs text-[#A2A2BA]">
          ...
          <span className="text-[11px] text-[#6E6E85]">
      ...
      <div className="lg:w-[55%] lg:h-screen flex flex-col justify-between p-6 lg:p-10 bg-[#080C14] lg:overflow-y-auto">
        ...
        <div className="w-full max-w-md mx-auto my-auto py-4">
          <div className="p-6 sm:p-8 bg-[#111726] border border-[#2C2C44] rounded-2xl shadow-2xl shadow-black/80">
            {children}
          </div>
        </div>

        {/* Bottom System Info */}
        <div className="text-center text-[11px] text-[#6E6E85] font-medium flex-shrink-0 pt-2 pb-1">
          {isAr
