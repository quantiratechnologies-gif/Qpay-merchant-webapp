  ...
  return (
    ...
    >
      ...
      >
        ...
        <Card variant="elevated" style={{ padding: '18px 20px', background: 'linear-gradient(145deg, #171717 0%, #121212 100%)', border: '1px solid rgba(212, 175, 55, 0.25)' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            <span style={{ fontSize: '12.5px', color: '#A3A3A3', fontWeight: 600 }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
              <button
                ...
                style={{ background: 'none', border: 'none', color: '#A3A3A3', cursor: 'pointer', padding: 0, display: 'flex', alignItems: 'center' }}
              >
          ...
          <div style={{ display: 'flex', alignItems: 'baseline', gap: '8px', marginTop: '8px' }}>
            <span style={{ fontSize: '15px', color: '#D4AF37', fontWeight: 800 }}>{isAr ? 'ر.س' : 'SAR'}</span>
            <span style={{ fontSize: '26px', fontWeight: 900, color: '#D4AF37', letterSpacing: '-0.02em' }}>
      ...
      >
          ...
          <Card variant="elevated" style={{ padding: '18px 20px', background: '#171717', border: '1px solid #262626' }}>
            ...
            <div style={{ width: '100%', overflowX: 'auto' }}>
              <table style={{ width: '100%', borderCollapse: 'collapse', textAlign: isRtl ? 'right' : 'left' }}>
                <thead>
                  <tr style={{ borderBottom: '1px solid #262626', color: '#737373', fontSize: '11.5px', fontWeight: 700 }}>
                ...
                <tbody>
                  {merchantCollections.slice(0, 5).map((col) => (
                    ...
                    >
                      <td style={{ padding: '10px' }}>
                        <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                          ...
                          <div>
                            ...
                            <div style={{ fontSize: '10.5px', color: '#A3A3A3' }}>
                              {isAr
                      ...
                      <td style={{ padding: '10px', color: '#A3A3A3', fontFamily: 'monospace', fontSize: '11.5px' }}>
                        {col.id}
                      </td>
                      <td style={{ padding: '10px', color: '#A3A3A3', fontSize: '11.5px' }}>
                        {col.date}
                      </td>
                      <td style={{ padding: '10px' }}>
                        <StatusBadge
                      ...
                      <td style={{ padding: '10px', textAlign: isRtl ? 'left' : 'right', fontWeight: 900, color: '#D4AF37' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
          ...
          >
            ...
            <div style={{ margin: '14px 0', padding: '12px', backgroundColor: '#0B0B0B', borderRadius: '10px', border: '1px solid #262626' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
              ...
              <div style={{ fontSize: '11px', color: '#A3A3A3', fontFamily: 'monospace', marginTop: '3px' }}>
            ...
            >
              <Zap size={16} fill="#0B0B0B" color="#0B0B0B" />
              <span>
                {isSettling
          ...
          <Card variant="elevated" style={{ padding: '20px', textAlign: 'center', background: '#171717', border: '1px solid #262626' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '14px' }}>
              <span style={{ fontSize: '13.5px', fontWeight: 800, color: '#FFFFFF' }}>
                {isAr ? 'باركود PAY QR المعتمد' : 'Store PAY QR'}
              </span>
              <span style={{ fontSize: '11px', color: '#D4AF37', fontWeight: 800 }}>ZATCA Phase 2</span>
            </div>
            ...
            <div style={{ fontSize: '12px', color: '#A3A3A3', margin: '10px 0' }}>
